from ttkbootstrap import Frame, Treeview, Label, Button, DANGER, END, WARNING, OUTLINE, Scrollbar, VERTICAL, LIGHT, INFO
...
class LogFrame(Frame):
    def __init__(self, view, window):
        ...
        self.print_data_log_tabel_pdf_button = Button(self, text="Print Table Data", bootstyle=OUTLINE + INFO,
                                                      command=self.print_data_log_tabel_pdf_button_clicked)
        self.print_data_log_tabel_pdf_button.grid(row=2, column=0, columnspan=2, padx=(10, 10), pady=(10, 10))
    ...
    def print_data_log_tabel_pdf_button_clicked(self):
        result = self.user_business.pdf_data_logs(self.current_user)
        ...
        if error_message:
            ...
            Messagebox.show_info(title="Info", alert=True, message=save_message)
